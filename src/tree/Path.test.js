(function () {
    ...
    test("Instantiation", function () {
        ...
        throws(function () {
            $data.Path.create('foo');
        }, "should raise exception on invalid argument");

        var path = $data.Path.create(['test', 'path', 'it', 'is']);
    ...
    test("Conversion from string", function () {
        ...
        ok($data.Path.isBaseOf(path), "should return Path instance");
    ...
    test("Cloning", function () {
        ...
        ok(clonePath.isA($data.Path), "should return Path instance");
